...
int main(int argc, char **argv)
{
    ...
    //Carrega a SVM
    Ptr<ml::SVM> svm = ml::StatModel::load<ml::SVM>("classifier2.yml");
    ...
    int f = clock();
    cout << "O teste levou: " << (f-i)/(float)CLOCKS_PER_SEC << "s" << endl;
    ...
    cout << endl
              << "Numero de classificacoes: " << totalClassifications << endl;
